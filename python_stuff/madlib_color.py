...
story = """
\033[1;41mHello, my name is %(name)s. I'm from %(location)s. 
...
variables = {'name': name.capitalize(), 'location': location.capitalize(), 'transportation': transportation,
             'hobby': hobby, 'dislike': dislike}
